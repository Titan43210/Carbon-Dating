...
const Footer = () => {
    ...
    return (
        <Fade left>
        <footer className="text-gray-600 poppins bg-gray-700">
            <div className="max-w-screen-xl px-1 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex justify-end flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="poppins text-white text-base mb-3 font-semibold">About Us</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="poppins text-white text-base mb-3 font-semibold">Terms & Conditions</h2>
                        <nav className="list-none mb-10 flex flex-col space-y-2">
                            {/* list  */}
                            {
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="poppins text-white text-base mb-3 font-semibold">Privacy Policy</h2>
                        <nav className="list-none mb-10 flex flex-col space-y-2">
                            {/* list  */}
                            {
            ...
            <div className="bg-red-500">
                <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2022 carbondating (trading as www.carbondating.com) — Made with love
                    </p>
                </div>
            </div>
        </footer>
